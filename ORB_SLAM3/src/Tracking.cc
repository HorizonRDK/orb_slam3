    ...
    mnInitialFrameId(0), mbCreatedMap(false), mnFirstFrameId(0), mpCamera2(nullptr), mpLastKeyFrame(static_cast<KeyFrame*>(NULL))
{
    ...
    if(settings){
        ...
        {
            std::cout << "**ERROR in the config file, the format is not correct**" << std::endl;
            try
            {
                throw -1;
            }
...
bool Tracking::ParseCamParamFile(cv::FileStorage &fSettings)
{
    ...
    if(sCameraName == "PinHole")
    {
        ...
        {
            std::cout << "*Camera.k1 parameter doesn't exist or is not a real number*" << std::endl;
            b_miss_params = true;
        }
        ...
        {
            std::cout << "*Camera.k2 parameter doesn't exist or is not a real number*" << std::endl;
            b_miss_params = true;
        }
        ...
        {
            std::cout << "*Camera.p1 parameter doesn't exist or is not a real number*" << std::endl;
            b_miss_params = true;
        }
        ...
        {
            std::cout << "*Camera.p2 parameter doesn't exist or is not a real number*" << std::endl;
            b_miss_params = true;
        }
    ...
    else if(sCameraName == "KannalaBrandt8")
    {
        ...
        {
            std::cout << "*Camera.k3 parameter doesn't exist or is not a real number*" << std::endl;
            b_miss_params = true;
        }
        ...
        {
            std::cout << "*Camera.k4 parameter doesn't exist or is not a real number*" << std::endl;
            b_miss_params = true;
        }
        ...
        if(mSensor==System::STEREO || mSensor==System::IMU_STEREO || mSensor==System::IMU_RGBD){
            ...
            {
                std::cout << "*Camera2.fx parameter doesn't exist or is not a real number*" << std::endl;
                b_miss_params = true;
            }
            ...
            {
                std::cout << "*Camera2.fy parameter doesn't exist or is not a real number*" << std::endl;
                b_miss_params = true;
            }
            ...
            {
                std::cout << "*Camera2.cx parameter doesn't exist or is not a real number*" << std::endl;
                b_miss_params = true;
            }
            ...
            {
                std::cout << "*Camera2.cy parameter doesn't exist or is not a real number*" << std::endl;
                b_miss_params = true;
            }
            ...
            {
                std::cout << "*Camera2.k1 parameter doesn't exist or is not a real number*" << std::endl;
                b_miss_params = true;
            }
            ...
            {
                std::cout << "*Camera2.k2 parameter doesn't exist or is not a real number*" << std::endl;
                b_miss_params = true;
            }
            ...
            {
                std::cout << "*Camera2.k3 parameter doesn't exist or is not a real number*" << std::endl;
                b_miss_params = true;
            }
            ...
            {
                std::cout << "*Camera2.k4 parameter doesn't exist or is not a real number*" << std::endl;
                b_miss_params = true;
            }
            ...
            if(!node.empty())
            {
                ...
                {
                    std::cout << "*Tlr matrix have to be a 3x4 transformation matrix*" << std::endl;
                    b_miss_params = true;
                }
            }
            else
            {
                std::cout << "*Tlr matrix doesn't exist*" << std::endl;
                b_miss_params = true;
            }
    ...
    {
        std::cout << "*Not Supported Camera Sensor*" << std::endl;
        std::cout << "Check an example configuration file with the desired sensor" << std::endl;
    }
    ...
    if(mSensor==System::STEREO || mSensor==System::RGBD || mSensor==System::IMU_STEREO || mSensor==System::IMU_RGBD)
    {
        ...
        {
            std::cout << "*ThDepth parameter doesn't exist or is not a real number*" << std::endl;
            b_miss_params = true;
        }
    ...
    if(mSensor==System::RGBD || mSensor==System::IMU_RGBD)
    {
        ...
        {
            std::cout << "*DepthMapFactor parameter doesn't exist or is not a real number*" << std::endl;
            b_miss_params = true;
        }
...
bool Tracking::ParseORBParamFile(cv::FileStorage &fSettings) {
  ...
  if(!node.empty() && node.isInt()) {
    ...
    std::cout << "*ORBextractor.nFeatures parameter doesn't exist or is not an integer*" << std::endl;
    b_miss_params = true;
  }
  ...
  if(!node.empty() && node.isReal()) {
    ...
    std::cout << "*ORBextractor.scaleFactor parameter doesn't exist or is not a real number*" << std::endl;
    b_miss_params = true;
  }
  ...
  if(!node.empty() && node.isInt()) {
    ...
    std::cout << "*ORBextractor.nLevels parameter doesn't exist or is not an integer*" << std::endl;
    b_miss_params = true;
  }
  ...
  if(!node.empty() && node.isInt()) {
    ...
    std::cout << "*ORBextractor.iniThFAST parameter doesn't exist or is not an integer*" << std::endl;
    b_miss_params = true;
  }
  ...
  if(!node.empty() && node.isInt()) {
    ...
    std::cout << "*ORBextractor.minThFAST parameter doesn't exist or is not an integer*" << std::endl;
    b_miss_params = true;
  }
...
bool Tracking::ParseIMUParamFile(cv::FileStorage &fSettings)
{
    ...
    if(!node.empty())
    {
        ...
        {
            std::cout << "*Tbc matrix have to be a 4x4 transformation matrix*" << std::endl;
            b_miss_params = true;
        }
    }
    else
    {
        std::cout << "*Tbc matrix doesn't exist*" << std::endl;
        b_miss_params = true;
    }
    cout << endl;
    ...
    {
        std::cout << "*IMU.Frequency parameter doesn't exist or is not an integer*" << std::endl;
        b_miss_params = true;
    }
    ...
    {
        std::cout << "*IMU.NoiseGyro parameter doesn't exist or is not a real number*" << std::endl;
        b_miss_params = true;
    }
    ...
    {
        std::cout << "*IMU.NoiseAcc parameter doesn't exist or is not a real number*" << std::endl;
        b_miss_params = true;
    }
    ...
    {
        std::cout << "*IMU.GyroWalk parameter doesn't exist or is not a real number*" << std::endl;
        b_miss_params = true;
    }
    ...
    {
        std::cout << "*IMU.AccWalk parameter doesn't exist or is not a real number*" << std::endl;
        b_miss_params = true;
    }
...
std::shared_ptr<Frame> Tracking::CreateFrame(
...
Sophus::SE3f Tracking::GrabImageStereo(const cv::Mat &imRectLeft, const cv::Mat &imRectRight, const double &timestamp, string filename)
{
    ...
    if (mSensor == System::STEREO && !mpCamera2) {
      mCurrentFrame = Frame(mImGray,imGrayRight,timestamp,
              mpORBextractorLeft,mpORBextractorRight,mpORBVocabulary,mK,mDistCoef,mbf,mThDepth,mpCamera);
      //  std::cout << "mTlr\n" << mTlr.matrix() << std::endl;
    }
    else if(mSensor == System::STEREO && mpCamera2) {
        ...
        if(!mbOnlyTracking)
        {
            ...
            if(mState==OK)
            {
                ...
                else
                {
                    ...
                    if(!bOK) {
                      Verbose::PrintMess("TRACK: Track with MotionModel failed, "
                              "so track with ReferenceKeyFrame", Verbose::VERBOSITY_NORMAL);
                      bOK = TrackReferenceKeyFrame();
                      if (!bOK) {
                        Verbose::PrintMess("TRACK: TrackReferenceKeyFrame failed",
            ...
            else  //  mState != OK
            {
                ...
                else if (mState == LOST) //  mState != RECENTLY_LOST
                {
...
bool Tracking::TrackReferenceKeyFrame()
{
    ...
    {
      std::cout << "TRACK_REF_KF: " << nmatches
           << " Less than " << matches_th << " matches!! \n";
      return false;
    } else {
      std::cout << "TRACK_REF_KF nmatches: " << nmatches << std::endl;
    }
...
bool Tracking::TrackLocalMap()
{
    ...
    if(mCurrentFrame.mnId<mnLastRelocFrameId+mMaxFrames && mnMatchesInliers<20) {
      std::cout << "mCurrentFrame.mnId: " << mCurrentFrame.mnId << std::endl;
...
void Tracking::ResetActiveMap(bool bLocMap)
{
    ...
    if(mpViewer)
    {
        ...
        while(!mpViewer->isStopped()) {
          usleep(1000 * 1000);
          std::cout << "waitting for viewer stop" << std::endl;
        }
    }
